<template>
  <v-app>
    ...
    <v-snackbar :timeout="5000" :top="true" :vertical="true" v-model="wcSnackbar">
      {{ $t("message.weChatSB") }}
      <v-btn flat color="pink" @click.native="wcSnackbar = false">Close</v-btn>
    </v-snackbar>
    <v-snackbar :timeout="5000" :top="true" :vertical="true" v-model="extSnackbar">
      {{ $t("message.extensionSB") }}
      <v-btn flat color="pink" @click.native="extSnackbar = false">Close</v-btn>
    </v-snackbar>
    <v-snackbar :timeout="5000" :top="true" :vertical="true" v-model="nanoSnackbar">
      {{ $t("message.nanoSB") }}
      <v-btn flat color="pink" @click.native="nanoSnackbar = false">Close</v-btn>
    </v-snackbar>
  </v-app>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      wcSnackbar: navigator.userAgent.match(/MicroMessenger/gi),
      extSnackbar: false,
      nanoSnackbar: false
    };
  },
